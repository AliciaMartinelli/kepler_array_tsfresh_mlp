...
test_features, test_labels, test_kepler_ids = extract_tsfresh_features(TEST_DIR)
...
np.save("kepler_filenames_train.npy", train_kepler_ids)
np.save("kepler_filenames_val.npy", val_kepler_ids)
np.save("kepler_filenames_test.npy", test_kepler_ids)

np.save("X_train_kepler.npy", X_train_scaled)
np.save("y_train_kepler.npy", y_train)

np.save("X_val_kepler.npy", X_val_scaled)
np.save("y_val_kepler.npy", y_val)
